...
public class AboutActivity extends AbsAboutActivity {
    ...
    protected void onItemsCreated(@NonNull Items items) {
        ...
        items.add(new License("AJM","안전모",License.APACHE_2,"https://github.com/SeongJaeMoon/AJM"));
        items.add(new License("AJM","CommonCreativeLicense(CCL)",License.CCL,"https://github.com/SeongJaeMoon/AJM"));
        items.add(new Line());
        ...
        // 보행자전용도로(서울시 열린데이터 광장),
        // 사고다발지역(서울시 열린데이터 광장), 어린이보호구역정보(공공데이터 포털),
        // 보행자전용도로(서울시시설관리공단, 공공데이터 포털)
    }
